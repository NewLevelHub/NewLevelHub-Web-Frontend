          ...
          <table className="w-full table-fixed min-w-[900px] divide-y divide-[color:var(--border)] text-sm">
              <thead className="bg-surface text-left">
                <tr>
                  ...
                  <th className="w-[12%] px-4 py-3 font-medium text-primary">{t('passes.owner')}</th>
                  ...
                  <th className="w-[8%] px-4 py-3 font-medium text-primary">{t('common.status')}</th>
                  <th className="w-[12%] px-4 py-3 font-medium text-primary">{t('passes.columnChecker')}</th>
                  <th className="w-[11%] px-4 py-3 font-medium text-primary">{t('passes.columnValidated')}</th>
                  <th className="w-[6%] px-4 py-3 font-medium text-primary">{t('passes.columnMethod')}</th>
                  <th className="w-[8%] px-4 py-3 font-medium text-primary text-right">{t('passes.columnDetails')}</th>
                </tr>
              </thead>
